    ...
    <ShaderBackground>
      <div className="absolute inset-0 flex flex-col items-start justify-center px-8 md:px-8 pt-20 pb-24 z-10">
        <div className="max-w-xl text-left">
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-semibold tracking-tight text-gray-900 dark:text-white md:text-gray-900 dark:md:text-white leading-[1.1] mb-6 text-left [text-shadow:none] dark:[text-shadow:0_2px_18px_rgba(140,82,255,0.45)] md:[text-shadow:0_1px_2px_rgba(255,255,255,0.8)] dark:md:[text-shadow:0_2px_20px_rgba(140,82,255,0.5)]" suppressHydrationWarning>
            {title}
          </h1>
